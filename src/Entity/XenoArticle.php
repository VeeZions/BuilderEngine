...
class XenoArticle
{
     ...
     */
    #[ORM\ManyToMany(targetEntity: XenoLibrary::class, mappedBy: 'article')]
    ...
    public function getCategory(): ?XenoCategory
    {
        return $this->category;
    }

    public function setCategory(?XenoCategory $category): static
    {

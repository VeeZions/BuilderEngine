                    ...
                    ->children()
                        ->arrayNode('articles_routes')
                            ...
                            ->children()
                                ...
                                ->end()
                                ->scalarNode('show')
                                    ->defaultValue(ConfigConstant::CONFIG_DEFAULT_ROUTES['articles_routes']['show'])
                                    ->cannotBeEmpty()
                                ->end()
                                ->scalarNode('new')
                        ...
                        ->arrayNode('categories_routes')
                            ...
                            ->children()
                                ...
                                ->end()
                                ->scalarNode('show')
                                    ->defaultValue(ConfigConstant::CONFIG_DEFAULT_ROUTES['categories_routes']['show'])
                                    ->cannotBeEmpty()
                                ->end()
                                ->scalarNode('new')
                        ...
                        ->arrayNode('pages_routes')
                            ...
                            ->children()
                                ...
                                ->end()
                                ->scalarNode('show')
                                    ->defaultValue(ConfigConstant::CONFIG_DEFAULT_ROUTES['pages_routes']['show'])
                                    ->cannotBeEmpty()
                                ->end()
                                ->scalarNode('new')
                        ...
                        ->arrayNode('navigations_routes')
                            ...
                            ->children()
                                ...
                                ->end()
                                ->scalarNode('show')
                                    ->defaultValue(ConfigConstant::CONFIG_DEFAULT_ROUTES['navigations_routes']['show'])
                                    ->cannotBeEmpty()
                                ->end()
                                ->scalarNode('new')

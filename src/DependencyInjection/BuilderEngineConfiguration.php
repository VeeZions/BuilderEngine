                ...
                ->arrayNode('pagination_buttons')
                    ...
                    ->children()
                        ->scalarNode('first_button')
                            ->defaultValue('@BuilderEngineInternal/icons/pagination-first.html.twig')
                            ->cannotBeEmpty()
                        ->end()
                        ->scalarNode('previous_button')
                            ->defaultValue('@BuilderEngineInternal/icons/pagination-previous.html.twig')
                            ->cannotBeEmpty()
                        ->end()
                        ->scalarNode('next_button')
                            ->defaultValue('@BuilderEngineInternal/icons/pagination-next.html.twig')
                            ->cannotBeEmpty()
                        ->end()
                        ->scalarNode('last_button')
                            ->defaultValue('@BuilderEngineInternal/icons/pagination-last.html.twig')
                            ->cannotBeEmpty()
                        ->end()
                    ->end()
                ->end()
                ->arrayNode('crud_buttons')
                    ...
                    ->children()
                        ->scalarNode('edit_label')
                            ->defaultValue('@BuilderEngineInternal/table/crud-edit.html.twig')
                            ->cannotBeEmpty()
                        ->end()
                        ->scalarNode('delete_label')
                            ->defaultValue('@BuilderEngineInternal/table/crud-delete.html.twig')
                            ->cannotBeEmpty()
                        ->end()
                    ->end()
                ->end()

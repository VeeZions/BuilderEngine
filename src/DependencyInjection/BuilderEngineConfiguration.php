        ...
        $treeBuilder->getRootNode()
            ->children()
                ...
                ->arrayNode('enabled_locales')
                    ->scalarPrototype()->end()
                    ->defaultValue(ConfigConstant::CONFIG_DEFAULT_ENABLED_LOCALES)
                ->end()
                ...
                ->end()
                ->scalarNode('front_pagination_limit')
                    ->defaultValue(ConfigConstant::CONFIG_DEFAULT_FRONT_PAGINATION_LIMIT)
                    ->info('Front pagination limit')
                ->end()
                ->scalarNode('crud_pagination_limit')
                    ->defaultValue(ConfigConstant::CONFIG_DEFAULT_CRUD_PAGINATION_LIMIT)
                    ->info('Crud pagination limit')
                ->end()
